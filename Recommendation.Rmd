...
```{r , warning= FALSE, eval = TRUE, cache = FALSE}
...
I then moved onto oversampling the original data, this is primarily done oversampling instances from the minority class while keeping intact the points from the majority class. Once the oversampled dataset is created Logistic, SVM and Randomforest classifiers are modeled upon it. 
```{r , warning= FALSE, eval = TRUE, cache=TRUE}
